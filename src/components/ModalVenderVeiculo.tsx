...
export const ModalVenderVeiculo: React.FC<ModalVenderVeiculoProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const novaVenda: VendaVeiculo = {
      ...
      lucroLiquido: Number((lucroBruto - totalComissoesAtivasValor).toFixed(2)),
      lucroHistoricoOriginal: Number((lucroBruto - totalComissoesAtivasValor).toFixed(2)),
      margemLucroPercent: custoTotal > 0 ? ((lucroBruto - totalComissoesAtivasValor) / custoTotal) * 100 : 0,
